...
public class Controller {
	...
	private static List<GridChangedListener> gridChangedListeners = new ArrayList<GridChangedListener>(); //an array of grid listeners
	private static List<SerialPortListener>   serialPortListeners = new ArrayList<SerialPortListener>(); //an array of serial port listeners
	private static List<ChartListener>             chartListeners = new ArrayList<ChartListener>(); //an array of chart listeners
	private static SerialPort port; //serial port used to connect to Arduino
	private static Thread serialPortThread; //thread used to read data from Arduino
	private static AtomicBoolean dataStructureDefined = new AtomicBoolean(false); //used as flags for threads
	...
	/*
	 * @return An array of strings that describe the peripheral device names
	 */
